...
var Motor = exports.Motor = function (_React$Component) {
  (0, _inherits3.default)(Motor, _React$Component);
  ...
  function Motor() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Motor.__proto__ || (0, _getPrototypeOf2.default)(Motor)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = function (_ref2) {
    ...
    value: function render() {
      ...
      if ('schema' in definition) {
        ...
        return _react2.default.createElement(
          'div',
          { className: 'shinkansen-motor', key: 'shinkansen-motor' },
