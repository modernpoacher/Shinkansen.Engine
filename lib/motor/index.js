...
var Motor = exports.Motor = function (_React$Component) {
  ...
  function Motor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Motor.__proto__ || Object.getPrototypeOf(Motor)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = function (_ref2) {
